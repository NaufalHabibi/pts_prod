...
<div class="row">
<div class="col-lg-6">
<span class="logo">Corona Quiz</span></div>
<?php
...
if (@$_GET['q'] == 0)
    echo 'class="active"';
?>><a href="dash.php?q=0">Home<span class="sr-only"></span></a></li>
        <li <?php
if (@$_GET['q'] == 1)
    echo 'class="active"';
...
if (@$_GET['q'] == 4)
    echo 'class="active"';
?>><a href="dash.php?q=4">Tambahkan Quiz</a></li>
        <li <?php
if (@$_GET['q'] == 5)
    echo 'class="active"';
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="right" name="right" placeholder="masukan tanda pada jawaban yang benar" class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="wrong" name="wrong" placeholder="masukan tanda minus ke jawaba yang salah" class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="time" name="time" placeholder="masukan waktu pengerjaan" class="form-control input-md" min="1" type="number">
...
if (@$_GET['q'] == 4 && (@$_GET['step']) == 2) {
    echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>masukan detail pertanyaan</b></span><br /><br />
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <textarea rows="3" cols="5" name="qns' . $i . '" class="form-control" placeholder="tulis pertanyaan nomor' . $i . ' disini..."></textarea>  
  </div>
</div>
<div class="form-group">
  <label class="col-md-12 control-label" for="' . $i . '1"></label>  
  <div class="col-md-12">
  <input id="' . $i . '1" name="' . $i . '1" placeholder="masukan pilihan a" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="' . $i . '2" name="' . $i . '2" placeholder="masukan pilihan b" class="form-control input-md" type="text">
