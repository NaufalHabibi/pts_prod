...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Masukan nama" class="form-control input-md" type="text" value="<?php
echo $_GET['name'];
?>">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Masukan id (contoh. BE/10XXX/YY)" class="form-control input-md" type="text" value="<?php
echo $_GET['rollno'];
?>">
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <select id="branch" name="branch" placeholder="Pilih jurusan" class="form-control input-md" >
   <option value="" <?php
...
if ($_GET['branch'] == "IT")
    echo "selected";
?>>Otomasisasi Tata Kelola Perkantoran</option>
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <input id="username" name="username" placeholder="Pilih username" class="form-control input-md" type="username" value="<?php
echo $_GET['username'];
?>" style="<?php
if (isset($_GET['q7']))
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="phno" name="phno" placeholder="Masukan nomor telepon" class="form-control input-md" type="number" value="<?php
echo $_GET['phno'];
?>">
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <input id="cpassword" name="cpassword" placeholder="Cek Password" class="form-control input-md" type="password">
...
<div class="col-md-2 box">
<a href="about.php" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new"></a></div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><span style="color:darkblue;font-size:12px;font-weight: bold"></span></h4>
      </div>
